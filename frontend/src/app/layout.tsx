...
export const metadata: Metadata = {
  title: "Compare Your Website — Trust & Conversion Audit",
  description:
    "Audit any website's trust signals, find conflicting claims across pages, and estimate the revenue you lose to form friction.",
};
